...
module MRuby::HashBenchmark
  autoload :HtmlUtil, 'mruby/hash_benchmark/html_util'

  class Report
    class Document < Base
      include ChartHelper

      TITLE = "Hash Benchmark for mruby"
      GITHUB_URL = "https://github.com/shuujii/mruby-hash-benchmark"
